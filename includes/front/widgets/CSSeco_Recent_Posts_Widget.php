...
/**
  * @package eyalb
  * includes/front/widgets/CSSeco_Recent_Posts_Widget.php
  *
  */

// CSSeco recent posts widget
class CSSeco_Recent_Posts_Widget extends WP_Widget {
	
	// setup the widget name, description and shit
	public function __construct() {
		
		$widget_ops = array(
			'classname'	=> 'csseco-recent-posts-widget',
			'description' => 'Custom Recent Posts Widget'
		);
		parent::__construct( 'csseco_recent_posts', 'CSSeco Recent Posts', $widget_ops );
	...
	public function form( $instance ) {
		...
		$title = ( !empty( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Recent Posts', 'eyalb' ) );
...
add_action( 'widgets_init', function() {
	register_widget( 'CSSeco_Recent_Posts_Widget' );
});